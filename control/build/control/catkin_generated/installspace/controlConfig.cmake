...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/poposhca/Desktop/Entrega1/control/install/${idir}'.  Ask the maintainer 'poposhca <poposhca@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/poposhca/Desktop/Entrega1/control/install/lib;/home/poposhca/Desktop/EK_AutoNOMOS/AutoNOMOS_simulation/devel/lib;/opt/ros/kinetic/lib)
