...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/poposhca/Desktop/Entrega1/control/src/control)
  set(control_DEVEL_PREFIX /home/poposhca/Desktop/Entrega1/control/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/poposhca/Desktop/Entrega1/control/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'poposhca <poposhca@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/poposhca/Desktop/Entrega1/control/src/control/${idir}'.  Ask the maintainer 'poposhca <poposhca@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/poposhca/Desktop/Entrega1/control/devel/lib;/home/poposhca/Desktop/EK_AutoNOMOS/AutoNOMOS_simulation/devel/lib;/opt/ros/kinetic/lib)
